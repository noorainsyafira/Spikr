...
import com.example.spikr.CustomDialogFragment;
import com.example.spikr.DatabaseOp;
import com.example.spikr.LaptopCheckOutInfo;
import com.example.spikr.LaptopInfo;
import com.example.spikr.R;
import com.example.spikr.ScannerResult;
...
public class Scanner extends AppCompatActivity implements ZXingScannerView.ResultHandler, CustomDialogFragment.CustomDialogListener {
    ...
    public void handleResult(Result rawResult) {
        Toast.makeText(Scanner.this, "Verifying...",Toast.LENGTH_SHORT).show();
        //spinning loader
...
//            if (format) {
            ...
            //customDialog.showAlertDialog(R.layout.activity_scanner_result, this, "Is the information correct?");
                ...
                Toast.makeText(Scanner.this, "Record not exist, redirecting to add laptop...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Scanner.this, ScannerResult.class);
...
//            else {
//                Toast.makeText(Scanner.this, "Format Dialog bug...", Toast.LENGTH_SHORT).show();
...
//        startActivity(intent);
        this.format = true;
        Toast.makeText(Scanner.this, "Dialog Click OK...", Toast.LENGTH_LONG).show();
    }
    ...
    private void showScanResultDialog(String title, String message) {
        ...
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(Scanner.this,"Format correct, please proceed...",Toast.LENGTH_SHORT).show();
//                Intent intent = new Intent(Scanner.this, ScannerResult.class);
//                intent.putExtra("laptop_info", li); //return the object li as a serialized object
//                startActivity(intent);
            }
    ...
    private void showAlertDialog(String key) {
        ...
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                // send data from the AlertDialog to the Activity
                //EditText editText = customLayout.findViewById(R.id.edit_studentName);
                Toast.makeText(Scanner.this,"Redirecting...",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Scanner.this, ScannerResult.class);
